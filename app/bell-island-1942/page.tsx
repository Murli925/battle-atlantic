        ...
        description={
          <>
            <p className="mb-2">
              ...
              Bay was considered relatively secure, its strategic value ensured
              that it attracted the attention of German naval planners.
            </p>
            <p className="mb-2">
            ...
            <p>
              ...
              attacks exposed weaknesses in local harbour defences, highlighted
              the strategic importance of Newfoundland within the Allied
              Atlantic supply system, and left a legacy that remains visible
              today. The wrecks, coastal defences, industrial infrastructure,
              and memorial sites together form one of the most intact and
              geographically concentrated Second World War naval battle
        ...
        blocks={[
          {
            ...
            title: (
              <>
                5 September 1942 — U-boat <i>U-513</i> Attack
              </>
            ),
            description: (
              <>
                ...
                <ContentSection
                  ...
                  description={
                    <>
                      <p className="mt-2">
                        On 5 September 1942, the German submarine <i>U-513</i>—a
                        long-range Type IXC U-boat under the command of
                        Korvettenkapitän Rolf Rüggeberg— entered Conception Bay.
                        Navigating through narrow approaches, shoals, and tidal
                        currents, the submarine penetrated deep into the bay and
                        approached the anchorage off Bell Island.
                      </p>

                      <p className="mt-2">
                        There, several ore carriers lay at anchor or were
                        engaged in loading operations.
                      </p>

                      <p className="mt-2">
                        At approximately 11:00 a.m., <i>U-513</i> fired
                        torpedoes into the anchored ships. The British vessel
                        <i>Saganaga</i> was struck first. The explosion was
                        catastrophic: the ship sank in well under a minute,
                        giving the crew almost no time to respond. Twenty-nine
                        men were killed.
                      </p>
                      ...
                      <p className="mt-2">
                        The attack occurred within sight of shore. Residents of
                        Bell Island witnessed the explosions, the sinking ships,
                        and the aftermath as survivors struggled in the water.
                        Local vessels and civilians participated in rescue
                        efforts, bringing survivors ashore.
                      </p>
...

          {
            ...
            title: (
              <>
                2 November 1942 — U-boat <i>U-518</i> Attack
              </>
            ),
            description: (
              <>
                ...
                <ContentSection
                  ...
                  description={
                    <>
                      <p className="mt-2">
                        Nearly two months later, on 2 November 1942, a second
                        German submarine <i>U-518</i>, also a Type IXC boat
                        under the command of Oberleutnant zur See
                        Friedrich-Wilhelm Wissmann—repeated the feat.
                      </p>

                      <p className="mt-2">
                        Once again, a U-boat penetrated Conception Bay and
                        reached the Bell Island anchorage.
                      </p>
                      ...
                      <p className="mt-2">
                        ...
                        combination of Royal Canadian Navy patrol
                        craft—particularly Fairmile motor launches— and local
                        civilian vessels. Many reached shore directly.
                      </p>
                    </>
                  }
...

          {
            ...
            description: (
              <>
                ...
                <p className="mt-2">
                  That both <i>U-513</i> and <i>U-518</i> succeeded underscores
                  both the skill of their commanders and the absence of
                  effective anti-submarine defences at Bell Island in 1942.
                </p>
                <Gallery
                  items={[
                    {
      ...
      <ContentSection
        ...
        description={
          <>
            ...
            <p className="mt-4">
              <strong>Vessels Sunk at Bell Island:</strong>{" "}
              <i>Rose Castle, PLM-27</i>
            </p>

            <p className="mt-4">
              <strong>Later Fate:</strong> <i>U-518</i> was sunk on 22 April
              1945 in the North Atlantic northwest of the Azores by depth
              charges from the U.S. destroyer escorts USS Carter and USS Neal A.
              Scott, with the loss of all 56 hands.
            </p>
            <p className="mt-4">
              <strong>Additional notes:</strong> After sinking Rose Castle and
              <i>PLM-27</i>, Wissmann successfully landed a German intelligence
              agent at Baie des Chaleurs in Quebec on 9 November 1942. By
              December, Wissmann was promoted to Kapitänleutnant (Lieutenant
              Commander). After leaving U-518, he served as a training officer
              with the 2nd, 10th, and 26th (Training) Flotillas until the end of
              the war in May 1945.
            </p>
          </>
        }
      ...
      <ContentSection
        ...
        description={
          <>
            ...
            <p className="text-gray-500">
              (From left to right: RCAF Liberator Searching for U-boats (left),
              RCAF Liberators Attacking U-Boat (middle), RCAF Liberator Flying
              Protecting Convoy (right))
            </p>
